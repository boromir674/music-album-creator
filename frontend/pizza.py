...
questions = [
    ...
    {
        'type': 'expand',  # type one of the keys below and then see the mapped selection. 'h' for help
        'name': 'toppings',
    ...
    {
        'type': 'rawlist',  # type 1,2,3, .. n (as many as choices) and see highlighted selection
        'name': 'beverage',
